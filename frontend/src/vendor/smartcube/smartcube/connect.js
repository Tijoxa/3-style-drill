import { filter, take, TimeoutError } from 'rxjs';
...
import { removeCachedMacForDevice, setCachedMacForDevice, waitForManufacturerData, } from './attachment/address-hints';
...
export async function connectSmartCube(arg) {
